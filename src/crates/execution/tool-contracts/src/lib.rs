...
pub use deferred_tool::{
    ...
    call_deferred_tool_short_description, canonicalize_call_deferred_tool_input,
    effective_tool_invocation, parse_call_deferred_tool_input, serialize_call_deferred_tool_input,
    CallDeferredToolInput, CallDeferredToolInputError, ResolvedToolInvocation, ToolInvocationKind,
